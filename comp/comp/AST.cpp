...
char* arr [] =	{"intNode", "floatNode", "stringNode","CharNode","IdentNode","longidNode","CompNode",
	...
	"stmtListNode","ForNode","ForHdrNode","ForIniNode","LogExpNode","AsgExpNode","SmpExpNode","WhileNode","WleHdrNode","DoWhlNode"
		,"CondtiNode","if_node","if_else_node","SwitchNode","SwtBdyNode","IfHdrNode","argListNode","argNode","ProtclHdrNode","ProtclNode","ProtclBdyNode","MsgNode","MsgCalNode","SndrNode","BlockNode","ReturnNode",
		...
		"SmpExpPlusNode","SmpExpMinusNode","SmpExpMultiNode","SmpExpDivNode","LESS_THAN_Node","MORE_THAN_Node","LESS_EQUAL_Node","MORE_EQUAL_Node","EQUAL_EQUAL_Node","NOT_EQUAL_Node","AND_AND_Node","OR_OR_pNode","NSLogNode"};
